...
from .views import ChatListCreateView,ChatListView,fetch_chat_by_receiver_id
urlpatterns = [
    ...
    path('chat/fetch/<int:receiver_id>/',fetch_chat_by_receiver_id, name='fetch_chat_by_receiver_id'),
]
